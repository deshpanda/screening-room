...
// Frost and tinsel: the winter shelf. Curated, not detected — keyword and
// genre matching drags in junk and misses the ones that matter (Eyes Wide Shut
// is a Christmas film; no metadata will ever tell you that). Each entry carries
// the vibe it belongs to, so the shelf can be read in flavours rather than as
// one undifferentiated pile. Watched films stay in by design: rewatching Die
// Hard in December is the tradition, not a failure of the recommender.
export const WINTER_VIBES = {
  tinsel: { short: 'tinsel', note: 'Christmas that does not feel like Christmas' },
  snowbound: { short: 'dread', note: 'snowbound, and nobody is coming' },
  canon: { short: 'canon', note: 'the Christmas canon, unembarrassed' },
  ensemble: { short: 'ensemble', note: 'the Love Actually family, and its ancestors' },
  nye: { short: 'new year', note: 'New Year’s Eve, specifically' },
  melancholy: { short: 'melancholy', note: 'winter as a state of mind' },
  found: { short: 'found', note: 'turned up by the projector, not chosen by hand' },
};

// Keywords the top-up searches, so the collection cannot run dry once the
// curated list is exhausted. Verified against TMDB's keyword endpoint.
export const WINTER_KEYWORDS = [
  ['christmas', 207317],
  ['christmas eve', 260365],
  ['snow', 10794],
  ['winter', 1442],
  ["new year's eve", 613],
  ['blizzard', 156783],
...
export const WINTER_FILMS = [
  // --- Christmas that does not feel like Christmas ---
  ['Die Hard', '1988', 'the ur-text: Christmas party, machine guns', 'tinsel'],
  ['Lethal Weapon', '1987', 'a Los Angeles Christmas with a death wish', 'tinsel'],
  ['Batman Returns', '1992', 'Gotham under snow, the darkest studio Christmas', 'tinsel'],
  ['Gremlins', '1984', 'a Christmas gift with feeding instructions', 'tinsel'],
  ['In Bruges', '2008', 'Christmas in a fairytale town, purgatory as tourism', 'tinsel'],
  ['Kiss Kiss Bang Bang', '2005', 'Christmas noir, narrated by a thief', 'tinsel'],
  ['Eyes Wide Shut', '1999', 'every frame lit by a Christmas tree, and it is not festive', 'tinsel'],
  ['Brazil', '1985', 'bureaucracy, torture, and Christmas carols', 'tinsel'],
  ['Trading Places', '1983', 'a Christmas bet between men who own everything', 'tinsel'],
  ['Rare Exports: A Christmas Tale', '2010', 'Finland excavates the real Santa; it is a monster', 'tinsel'],
  ['Black Christmas', '1974', 'the sorority-house slasher that predates Halloween', 'tinsel'],
  ['Iron Man 3', '2013', 'Shane Black cannot write a film without Christmas', 'tinsel'],

  // --- Snowbound dread ---
  ['The Shining', '1980', 'the Overlook in winter, and the hedge maze', 'snowbound'],
  ['The Thing', '1982', 'Antarctic isolation and the paranoia of blood tests', 'snowbound'],
  ['Fargo', '1996', 'flat white nothing, and Minnesota politeness over murder', 'snowbound'],
  ['Misery', '1990', 'snowed in with your biggest fan', 'snowbound'],
  ['The Hateful Eight', '2015', 'a blizzard, a haberdashery, and eight liars', 'snowbound'],
  ['Wind River', '2017', 'a body in the snow on a Wyoming reservation', 'snowbound'],
  ['The Grey', '2012', 'Alaska, wolves, and a man out of reasons', 'snowbound'],
  ['The Revenant', '2015', 'winter as the antagonist, shot in natural light', 'snowbound'],
  ['Let the Right One In', '2008', 'Swedish snow, a jungle gym, a very old child', 'snowbound'],
  ['A Simple Plan', '1998', 'a bag of money in the snow ruins three lives', 'snowbound'],
  ['Winter’s Bone', '2010', 'Ozark winter, and a teenager looking for her father', 'snowbound'],
  ['Force Majeure', '2014', 'an avalanche, and a marriage that does not survive it', 'snowbound'],
  ['Society of the Snow', '2023', 'the Andes crash, told by the mountain', 'snowbound'],
  ['30 Days of Night', '2007', 'an Alaskan town, one long polar night, vampires', 'snowbound'],

  // --- The Christmas canon, unembarrassed ---
  ['It’s a Wonderful Life', '1946', 'the bleakest film ever mistaken for cosy', 'canon'],
  ['The Apartment', '1960', 'Christmas loneliness, then the best last line in cinema', 'canon'],
  ['Miracle on 34th Street', '1947', 'Santa on trial, and the state loses', 'canon'],
  ['A Christmas Story', '1983', 'the leg lamp, the Red Ryder, the tongue on the pole', 'canon'],
  ['Home Alone', '1990', 'a farce about property defence, scored like a hymn', 'canon'],
  ['Carol', '2015', 'department-store Christmas as the beginning of a life', 'canon'],
  ['The Holdovers', '2023', 'nobody at this boarding school wanted this Christmas', 'canon'],
  ['Tokyo Godfathers', '2003', 'Satoshi Kon: three homeless people, an abandoned baby, Tokyo at Christmas', 'canon'],
  ['Klaus', '2019', 'hand-drawn, and it earns every tear', 'canon'],
  ['The Muppet Christmas Carol', '1992', 'the definitive Dickens, and it has Gonzo narrating', 'canon'],
  ['Scrooged', '1988', 'Bill Murray as a television executive in hell', 'canon'],
  ['Bad Santa', '2003', 'the anti-Christmas film that is somehow still a Christmas film', 'canon'],
  ['Little Women', '2019', 'the Christmas breakfast they give away', 'canon'],

  // --- The Love Actually family ---
  ['Love Actually', '2003', 'the ensemble template everyone has copied since', 'ensemble'],
  ['The Holiday', '2006', 'two houses swapped, one cottage buried in snow', 'ensemble'],
  ['About Time', '2013', 'Richard Curtis on time travel, New Year’s, and mortality', 'ensemble'],
  ['Bridget Jones’s Diary', '2001', 'from the reindeer jumper to New Year’s in the snow', 'ensemble'],
  ['Serendipity', '2001', 'Christmas New York and a five-dollar bill as fate', 'ensemble'],
  ['While You Were Sleeping', '1995', 'a Christmas coma and a borrowed family', 'ensemble'],
  ['The Family Stone', '2005', 'a Christmas visit that goes very badly', 'ensemble'],
  ['Happiest Season', '2020', 'the meet-the-parents Christmas film that had to be made', 'ensemble'],
  ['Last Christmas', '2019', 'built entirely around one George Michael song', 'ensemble'],
  ['The Shop Around the Corner', '1940', 'Lubitsch, and the film You’ve Got Mail is standing on', 'ensemble'],
  ['Remember the Night', '1940', 'Sturges wrote it: a shoplifter and a prosecutor drive home for Christmas', 'ensemble'],
  ['Meet Me in St. Louis', '1944', 'where “Have Yourself a Merry Little Christmas” comes from, and it is a sad song', 'ensemble'],
  ['White Christmas', '1954', 'the Technicolor Vermont inn with no snow until it matters', 'ensemble'],
  ['The Bishop’s Wife', '1947', 'Cary Grant as an angel with an agenda', 'ensemble'],

  // --- New Year’s Eve, specifically ---
  ['When Harry Met Sally...', '1989', 'the Auld Lang Syne argument, and the run through the party', 'nye'],
  ['Sunset Boulevard', '1950', 'two New Year’s parties, one of them for two people', 'nye'],
  ['Boogie Nights', '1997', 'the 1979 to 1980 party: the longest, worst night in the film', 'nye'],
  ['Strange Days', '1995', 'millennium night in Los Angeles, sold as a recording', 'nye'],
  ['The Poseidon Adventure', '1972', 'the ship capsizes at midnight, mid-toast', 'nye'],
  ['Phantom Thread', '2017', 'the New Year’s Eve ball, and a dress that does not forgive', 'nye'],
  ['200 Cigarettes', '1999', 'everyone trying to get somewhere before midnight, 1981', 'nye'],

  // --- Winter as melancholy ---
  ['Winter Light', '1963', 'Bergman: a Swedish pastor, an empty church, no comfort offered', 'melancholy'],
  ['Fanny and Alexander', '1982', 'that Christmas feast, then everything after it', 'melancholy'],
  ['Winter Sleep', '2014', 'Ceylan: Anatolian snow and a marriage argued to death', 'melancholy'],
  ['Cold War', '2018', 'monochrome Poland, and love as a border crossing', 'melancholy'],
  ['Ida', '2013', 'a novice and her aunt drive through a grey Polish winter', 'melancholy'],
  ['Doctor Zhivago', '1965', 'the ice palace at Varykino, the most beautiful winter set ever built', 'melancholy'],
  ['The Ice Storm', '1997', 'suburban Connecticut freezes over at Thanksgiving 1973', 'melancholy'],
  ['Love Letter', '1995', 'Iwai: snowy Otaru, a letter to a dead man, and the answer', 'melancholy'],
  ['Atanarjuat: The Fast Runner', '2001', 'the first feature in Inuktitut, shot on the ice', 'melancholy'],
  ['The Grand Budapest Hotel', '2014', 'alpine snow, a funicular, and a stolen painting', 'melancholy'],
  ['Nanook of the North', '1922', 'where documentary began, in the Arctic', 'melancholy'],
  ['Groundhog Day', '1993', 'February in Punxsutawney, forever', 'melancholy'],
  ['Eternal Sunshine of the Spotless Mind', '2004', 'the frozen Charles, Montauk in February', 'melancholy'],
];
